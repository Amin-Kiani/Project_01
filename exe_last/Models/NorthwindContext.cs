...
namespace exe_last.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<TblCuShahinContract> TblCuShahinContract { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Branches>(entity =>
            {
                entity.HasKey(e => e.BranchId)
                    .HasName("PK__Branches__A1682FA563BD6DD2");
            ...
            modelBuilder.Entity<Customers>(entity =>
            {
                ...
                entity.Property(e => e.Bestankari).HasColumnType("money");
            ...
            modelBuilder.Entity<TblCuShahinContract>(entity =>
            {
                entity.HasKey(e => e.ContractId);

                entity.ToTable("Tbl_CU_Shahin_Contract");

                entity.Property(e => e.ContractNumber).HasMaxLength(50);

                entity.Property(e => e.ContractSubject).HasMaxLength(400);
                ...
                entity.Property(e => e.DateOfContract).HasMaxLength(10);
                ...
                entity.Property(e => e.FileUpload).HasMaxLength(200);

                entity.Property(e => e.Guid)
                    .HasColumnName("GUID")
                    .HasMaxLength(50);

                entity.Property(e => e.ServiceId).HasMaxLength(200);
